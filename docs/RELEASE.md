...
|--------------------|---------|--------|
| **2026-09-17** | `seatmesh@1.2.4` | Open agent kinds (`kindBase`/`extends`); oc-proxy extends opencode; prove/satisfy/recovery; act/card hub; wave OC relaunch; Orca credit CONTINUE; cross-mesh inbox restart |
