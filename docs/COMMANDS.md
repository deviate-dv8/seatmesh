...
- Run: `seatmesh campaign --help`
- Agent: `seatmesh agent help campaign`
- File: [cli/campaign.md](cli/campaign.md)
...
- Run: `seatmesh schedule --help`
- Agent: `seatmesh agent help schedule`
- File: [cli/schedule.md](cli/schedule.md)
...
- Run: `seatmesh sidebar --help`
- Agent: `seatmesh agent help sidebar`
- File: [cli/sidebar.md](cli/sidebar.md)
